...
디자인을 잘하는 것을 디자인감각이 뛰어나야 되서 잘못하겠다는 주변 소리를 많이 들었습니다. 디자인은 단순히 감각적으로 하는 것이 아닙니다. **심리학적**, **통계적**으로 접근하고 객관적인 근거로 사람이 심미적으로 느끼는 작품을 만드는 것입니다.

이 글에서는 디자인 요소들을 작업할 때는 각 요소별로 심리학적으로 접근하는 방법과 통계적으로 접근하는 방법을 설명합니다.
...
이 말은 매우 간단히 말해 주고 있다. 사물의 그룹을 볼 때, 각각의 사물들을 보기 전에 전체적인 모습을 인지합니다. 사물이 분리되어 존재하더라도, 부분 이전에 하나의 전체를 보는 것이다.
...
![](https://github.com/ChoDragon9/skills/blob/master/%EC%9E%90%EB%A3%8C/%ED%8E%98%EB%B6%81%EA%B7%B8%EB%A3%B9/1%EA%B3%BC%EC%A0%9C/20180725_%EB%94%94%EC%9E%90%EC%9D%B8%EA%B0%95%EC%A1%B0/3.png)
